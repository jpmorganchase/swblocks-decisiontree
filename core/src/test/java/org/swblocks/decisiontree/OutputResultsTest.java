...
/**
 * Test cases for {@link OutputResults}.
 */
public class OutputResultsTest {
    ...
    public void testConstruction() {
        ...
        final DecisionTreeRule decisionTreeRule =
                new DecisionTreeRule(new UUID(0, 1), UUID.randomUUID(), null, outputDriver, Instant.now(),
                        Instant.now());

        final OutputResults results = new OutputResults(decisionTreeRule);
